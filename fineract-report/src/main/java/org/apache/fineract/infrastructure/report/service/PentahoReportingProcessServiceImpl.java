    ...
    private String getTenantUrl() {
        ...
        if (fineractProperties.getMode().isReadOnlyMode()) {
            ...
            schemaName = getPropertyValue(tenantConnection.getReadOnlySchemaName(), "FINERACT_RO_SCHEMA_SCHEMA_NAME",
                    schemaName);
            schemaUsername = getPropertyValue(tenantConnection.getReadOnlySchemaUsername(), "FINERACT_RO_SCHEMA_USERNAME",
                    schemaUsername);
            schemaPassword = getPropertyValue(tenantConnection.getReadOnlySchemaPassword(), "FINERACT_RO_SCHEMA_PASSWORD",
                    schemaPassword);
